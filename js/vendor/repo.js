...
(function($){
    ...
    $.fn.repo = function( options ){
        ...
        // Insert CSS
        if(typeof _this.settings.css != 'undefined' && _this.settings.css !== '')
            $('body').prepend($('<style>').html(_this.settings.css));
                        ...
                        if(el.legnth > 0){
                            ...
                            $.ajax({
                                ...
                                success: function(response){
                                    ...
                                    el = $('<div class="file page" id="' + link.data('id') + '"><pre><code></code></pre></div>');
                                    ...
                                    $('#codez').html(el).prepend('<p>' + response.data.name + '</p>');
                                    $('pre').vanGogh();
                                }, 
